...
#define  AUDIO_PHY_RXADC_EXTRA_SRC_SEL  (0x130 - ADC_BASE_OFFSET)
//mars3
...
//	u32 mclk_source;
	struct mutex mutex; //protect adc instance
	u32 id;
...
struct dac_obj {
	...
	struct device *dev;
	struct miscdevice miscdev;
	struct mutex mutex; //protect dac instance
	u32 id;
	struct fmt_config config;
	u32 amp_gpio_l;
	u32 amp_gpio_r;
