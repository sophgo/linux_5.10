 ...
 *      0       0       1       1       Bit errors (3) were detected and corrected
...
struct cvsnfc_chip_info nand_flash_cvitek_supported_ids[] = {
	...
	/* DS35Q4GB-IB: DS35X4GB Rev.06, 3.3V ID E5h/B4h (Table 3.2),
	 * (2048+128)x64x4096, 8-bit/512B ECC, QE B0[0], ECC_EN B0[4]
	 */
	{
		{	.name = "DS35Q4GB-IB",
			.id = {0xe5, 0xb4},
