...
#define CVI_CV184X_SDHCI_PHY_TX_RX_DLY		(CVI_CV184X_SDHCI_VENDOR_OFFSET + 0x40)
#define CVI_CV184X_SDHCI_PHY_DS_DLY			(CVI_CV184X_SDHCI_VENDOR_OFFSET + 0x44)
#define CVI_CV184X_SDHCI_PHY_DLY_STS		(CVI_CV184X_SDHCI_VENDOR_OFFSET + 0x48)
#define CVI_CV184X_SDHCI_PHY_CONFIG			(CVI_CV184X_SDHCI_VENDOR_OFFSET + 0x4C)
